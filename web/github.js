    ...
    pr = await gh(`${R}/pulls`, {
      ...
      body: {
        ...
        body:
          ...
          "Nothing has been deployed. Review the files, then follow the generated README to run " +
          "`scripts/setup-azure-oidc.sh` once while this PR is open. The script sets the required " +
          "repo variables automatically. Merging runs what-if; real deployment requires a manual workflow run.",
      },
    });
  } catch (err) {
